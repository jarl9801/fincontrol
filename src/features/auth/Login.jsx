...
type="submit"
disabled={loading}
className={`w-full rounded-md bg-[var(--text-primary)] py-3 nd-mono text-[13px] font-medium uppercase tracking-[0.06em] text-[var(--black)] transition-opacity ${loading ? 'cursor-not-allowed opacity-50' : 'hover:opacity-85'}`}
>
