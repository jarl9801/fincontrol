...
const ReportCXC = ({ transactions }) => {
 ...
 <div>
 <h2 className="text-xl font-semibold tracking-[-0.03em] text-[var(--text-primary)]">Reporte de cuentas por cobrar</h2>
 ...
 className="inline-flex items-center gap-2 rounded-lg bg-[var(--success)] px-4 py-2 text-sm font-medium text-white transition hover:bg-[var(--success)]"
 >
 ...
 <p className="text-2xl font-semibold text-[var(--success)]">{formatCurrency(totalReceivable)}</p>
 ...
 <td className="py-3 text-center text-sm font-semibold text-[var(--text-primary)]">{receivables.length}</td>
 <td className="py-3 text-right text-sm font-semibold text-[var(--success)]">{formatCurrency(totalReceivable)}</td>
 </tr>
 </tbody>
 </table>
 </div>
