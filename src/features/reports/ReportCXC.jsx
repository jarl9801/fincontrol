  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold text-slate-800">Reporte de Cuentas por Cobrar</h2>
        <button
              ...
              {receivables.map(t => {
                ...
                return (
                  <tr key={t.id} className="hover:bg-[#13132a]">
                    ...
                    <td className="px-4 py-3 text-sm font-medium text-emerald-600 text-right">{formatCurrency(t.amount)}</td>
