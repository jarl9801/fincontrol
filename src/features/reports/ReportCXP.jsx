...
const ReportCXP = ({ transactions }) => {
 ...
 <div>
 <h2 className="text-xl font-semibold tracking-[-0.03em] text-[var(--text-primary)]">Reporte de cuentas por pagar</h2>
 ...
 className="inline-flex items-center gap-2 rounded-lg bg-[var(--accent)] px-4 py-2 text-sm font-medium text-white transition hover:bg-[var(--accent)]"
 >
 ...
 <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-[var(--text-secondary)]">Total por pagar</h3>
 <TrendingDown className="text-[var(--accent)]" size={20} />
 </div>
 <p className="text-2xl font-semibold text-[var(--accent)]">{formatCurrency(totalPayable)}</p>
 ...
 <p className="text-2xl font-semibold text-[var(--accent)]">{formatCurrency(overdueAmount)}</p>
 ...
 <p className="text-2xl font-semibold text-[var(--warning)]">{formatCurrency(criticalAmount)}</p>
 ...
 <p className="text-2xl font-semibold text-[var(--success)]">{formatCurrency(currentAmount)}</p>
 ...
 <th className="py-2 text-left text-sm font-semibold text-[var(--text-secondary)]">Periodo</th>
 <th className="py-2 text-center text-sm font-semibold text-[var(--text-secondary)]">Facturas</th>
 <th className="py-2 text-right text-sm font-semibold text-[var(--text-secondary)]">Monto</th>
 </tr>
 </thead>
 <tbody>
 ...
 <td className="py-3 text-sm font-semibold text-[var(--text-primary)]">Total</td>
 <td className="py-3 text-center text-sm font-semibold text-[var(--text-primary)]">{payables.length}</td>
 <td className="py-3 text-right text-sm font-semibold text-[var(--accent)]">{formatCurrency(totalPayable)}</td>
 </tr>
 </tbody>
 </table>
 </div>
 ...
 <h3 className="text-lg font-semibold tracking-[-0.03em] text-[var(--text-primary)]">Detalle de cuentas por pagar</h3>
 </div>
 <div className="overflow-x-auto">
 <table className="w-full text-left">
 <thead className="border-b border-[var(--border)] bg-[var(--surface-raised)]">
 <tr>
 <th className="px-4 py-3 text-xs font-semibold uppercase text-[var(--text-secondary)]">Fecha</th>
 <th className="px-4 py-3 text-xs font-semibold uppercase text-[var(--text-secondary)]">Descripción</th>
 <th className="px-4 py-3 text-xs font-semibold uppercase text-[var(--text-secondary)]">Proyecto</th>
 <th className="px-4 py-3 text-xs font-semibold uppercase text-[var(--text-secondary)]">Categoría</th>
 <th className="px-4 py-3 text-right text-xs font-semibold uppercase text-[var(--text-secondary)]">Monto</th>
 <th className="px-4 py-3 text-center text-xs font-semibold uppercase text-[var(--text-secondary)]">Días</th>
 </tr>
 </thead>
